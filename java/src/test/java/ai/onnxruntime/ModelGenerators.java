...
public final class ModelGenerators {
  ...
  public void generateExternalEmbedding() throws IOException {
      ...
      tensor.addExternalData(
              StringStringEntryProto.newBuilder().setKey("length").setValue(""+(4L*1024L*1024L*1024L)).build());
      ...
      try (OutputStream os =
                   Files.newOutputStream(Paths.get("src", "test", "resources", "java-external-embedding.onnx"))) {
